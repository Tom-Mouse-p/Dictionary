...
// Finction to fetch dictionary search results.
...
// Displaying the Searc Results in UI
const populateUI = (data) => {
    ...
    const spellBarCont = document.querySelector("#spellBar");
    spellBarCont.innerHTML = "";

    for (const mean in org) {
        if (Object.hasOwnProperty.call(org, mean)) {
            const orgArray = org[mean];
            var nm = 1;
            ...
            // Audio/Spell bar
            orgArray.phonetics.forEach((element) => {
                ...
                if (element.audio) {
                    ...
                    btn.innerHTML = `<svg width="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="0 0 700 700" width="700pt" height="700pt">
                        <defs>
            ...
            var word = orgArray.word;
            var phonetic = orgArray.phonetic;
            ...
            if (phonetic) {
                ...
                document
                    .querySelector("#resultSpell")
                    .classList.add("thinItalics");
            ...
            orgArray.meanings.forEach((element) => {
            ...
            spellBarCont.appendChild(spellBar);
        }
    }
};
